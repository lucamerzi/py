...
from google.cloud import datastore, bigquery, storage
...
df_dmp_volume = fetch_data_local(dmp_volume)
df_UU = fetch_data_local(UU)
df_UU_publisher = fetch_data_local(UU_publisher)
df_UU_DSP = fetch_data_local(UU_DSP)
df_freq_format = fetch_data_local(freq_format)
df_exc_DSP = fetch_data_local(exc_DSP)
df_exc_format = fetch_data_local(exc_format)
df_exc_publisher = fetch_data_local(exc_publisher)
df_UU_format = fetch_data_local(UU_format)
...
folderdestination='C:/Users/lmerzetti.WEBORAMA/Desktop/'
...
receivers_success = [os.environ['EMAIL_USER'], 'jbougard@weborama.com', 'diego@weborama.com']
receivers_unsuccess = [os.environ['EMAIL_USER'], 'jbougard@weborama.com']
...
def monitoring_alert (task,receivers):
    ...
    for receiver in receivers:
        ...
        smtpObj.starttls()
        smtpObj.login(os.environ['EMAIL_USER'], os.environ['EMAIL_PASSWORD'])
